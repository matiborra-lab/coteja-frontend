        ...
        pasos: [
          {
            ...
            texto: 'Pedix, Cucina Link (incluida su versión de solo carta, sin pedido activo), másDelivery, FUDO, Cartanube, Bistrosoft, Maxirest, Tucán, Toteat, Grow Brands y Rappi. Si el competidor usa alguna de estas, alcanza con pegar el link de su carta.',
            mock: (
              <Mock>
                <div className="flex flex-wrap gap-1.5">
                  {['Pedix', 'Cucina Link', 'másDelivery', 'FUDO', 'Cartanube', 'Bistrosoft', 'Maxirest', 'Tucán', 'Toteat', 'Grow Brands', 'Rappi'].map((p) => (
